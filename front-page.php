					...
					<!-- START REVOLUTION SLIDER 5.0 auto mode -->
						<div id="main_slider" class="rev_slider" data-version="5.0">
							<ul>
								...
								<!-- SLIDE1  -->
								<li data-index='rs-377' data-transition='curtain-1' data-slotamount='1' data-easein='default' data-easeout='default' data-masterspeed='default' data-thumb='<?php bloginfo('template_directory');?>/assets/images/home/slide-1.jpg' data-rotate='0' data-saveperformance='off' data-title='Business Solutions' data-description='' >
									<!-- MAIN IMAGE -->
									<img src="<?php bloginfo('template_directory');?>/assets/images/home/slide-1.jpg"  alt="image"  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg">
									<!-- LAYERS -->
									...
									<div class="tp-caption tp-resizeme rs-parallaxlevel-3" 
										...
										style="z-index: 5;">
										<img src="<?php bloginfo('template_directory');?>/assets/images/home/1.png" alt="">
									</div>
								...
								<!-- SLIDE2  -->
								<li data-index="rs-18" data-transition="zoomin" data-slotamount="7"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000"  data-thumb="<?php bloginfo('template_directory');?>/assets/images/home/slide-2.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Successful Careers" data-description="">
									<!-- MAIN IMAGE -->
									<img src="<?php bloginfo('template_directory');?>/assets/images/home/slide-2.jpg"  alt=""  data-bgposition="top center" class="rev-slidebg" data-no-retina>
									<!-- LAYERS -->
									<div class="tp-caption tp-resizeme" 
										...
										data-elementdelay="0.05" 
										style="z-index: 5;">
										<img src="<?php bloginfo('template_directory');?>/assets/images/home/4.png" alt="">
									</div>
								...
								<!-- SLIDE3  -->
								<li data-index="rs-20" data-transition="zoomin" data-slotamount="7"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000"  data-thumb="<?php bloginfo('template_directory');?>/assets/images/home/slide-3.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Your Success" data-description="">
									<!-- MAIN IMAGE -->
									<img src="<?php bloginfo('template_directory');?>/assets/images/home/slide-3.jpg"  alt=""  data-bgposition="top center"  class="rev-slidebg" data-no-retina>
									<!-- LAYERS -->
									...
									<div class="tp-caption tp-resizeme" 
										...
										data-elementdelay="0.05" 
										style="z-index: 5;">
										<img src="<?php bloginfo('template_directory');?>/assets/images/home/3.png" alt="">
									</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12t">
							<?php $banner1 = get_field('banner1'); ?>
							<div class="item wow fadeInLef" style="background-image: url(<?php bloginfo('template_directory');?>/assets/images/about/1.jpg);">
								<div class="offer-sec">
									<div class="inner-title"><?php echo $banner1['inner-title1'];?><div class="offer"><span>30% <br>OFF</span></div></div>
								</div>
								<div class="content">
									<h3><?php echo $banner1['heading1'];?></h3>
									<p><?php echo $banner1['paragraph1'];?> </p>
									<div class="link-btn"><a href="#" class="tran3s">More Products<span class="fa fa-sort-desc"></span></a></div>
								</div>
							</div>
						</div>
						<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12t">
							<div class="item wow fadeInRight" style="background-image: url(<?php bloginfo('template_directory');?>/assets/images/about/2.jpg);">
								<div class="offer-sec">
...
<!-- 		                
						<h3>
							<?php echo the_field('featured_products');?>
						</h3>
		            </div>
		            ...
		            <div class="row filter-list clearfix" id="MixItUp717B05">
			            ...
			            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 mix mix_all default-item all beauty others" style="display: inline-block;">
			                <div class="inner-box">
			                    <div class="single-item center">
			                        <figure class="image-box"><img src="<?php bloginfo('template_directory');?>/assets/images/shop/1.png" alt=""><div class="product-model new">New</div></figure>
			                        <div class="content">
			            ...
			            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 mix mix_all default-item all others" style="display: inline-block;">
			                <div class="inner-box">
			                    <div class="single-item center">
			                        <figure class="image-box"><img src="<?php bloginfo('template_directory');?>/assets/images/shop/2.png" alt=""></figure>
			                        <div class="content">
			                        	<h3><a href="shop-single.html">Turmeric Powder</a></h3>
			                            <div class="rating"><span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span></div>
			                            <div class="price">$12.99 <span class="prev-rate">$14.99</span></div>
			            ...
			            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 mix mix_all default-item all fruits vegetables beauty" style="display: inline-block;">
			                <div class="inner-box">
			                    <div class="single-item center">
			                        <figure class="image-box"><img src="<?php bloginfo('template_directory');?>/assets/images/shop/3.png" alt=""><div class="product-model hot">Hot</div></figure>
			                        <div class="content">
			                        	<h3><a href="shop-single.html">Turmeric Powder</a></h3>
			                            <div class="rating"><span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span></div>
			                            <div class="price">$12.99 <span class="prev-rate">$14.99</span></div>
			            ...
			            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 mix mix_all default-item all beauty others" style="display: inline-block;">
			                <div class="inner-box">
			                    <div class="single-item center">
			                        <figure class="image-box"><img src="<?php bloginfo('template_directory');?>/assets/images/shop/4.png" alt=""></figure>
			                        <div class="content">
			                        	<h3><a href="shop-single.html">Turmeric Powder</a></h3>
			                            <div class="rating"><span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span></div>
			                            <div class="price">$12.99 <span class="prev-rate">$14.99</span></div>
			            ...
			            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 mix mix_all default-item all fruits others" style="display: inline-block;">
			                <div class="inner-box">
			                    <div class="single-item center">
			                        <figure class="image-box"><img src="<?php bloginfo('template_directory');?>/assets/images/shop/5.png" alt=""></figure>
			                        <div class="content">
			                        	<h3><a href="shop-single.html">Turmeric Powder</a></h3>
			                            <div class="rating"><span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span></div>
			                            <div class="price">$12.99 <span class="prev-rate">$14.99</span></div>
			            ...
			            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 mix mix_all default-item all fruits vegetables beauty others" style="display: inline-block;">
			                <div class="inner-box">
			                    <div class="single-item center">
			                        <figure class="image-box"><img src="<?php bloginfo('template_directory');?>/assets/images/shop/6.png" alt=""><div class="product-model new">New</div></figure>
			                        <div class="content">
			                        	<h3><a href="shop-single.html">Turmeric Powder</a></h3>
			                            <div class="rating"><span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span></div>
			                            <div class="price">$12.99 <span class="prev-rate">$14.99</span></div>
			            ...
			            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 mix mix_all default-item all fruits others" style="display: inline-block;">
			                <div class="inner-box">
			                   <div class="single-item center">
			                        <figure class="image-box"><img src="<?php bloginfo('template_directory');?>/assets/images/shop/7.png" alt=""></figure>
			                        <div class="content">
			                        	<h3><a href="shop-single.html">Turmeric Powder</a></h3>
			                            <div class="rating"><span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span></div>
			                            <div class="price">$12.99 <span class="prev-rate">$14.99</span></div>
			            ...
			            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 mix mix_all default-item all fruits vegetables beauty others" style="display: inline-block;">
			                <div class="inner-box">
			                   <div class="single-item center">
			                        <figure class="image-box"><img src="<?php bloginfo('template_directory');?>/assets/images/shop/8.png" alt=""><div class="product-model hot">Hot</div></figure>
			                        <div class="content">
			                        	<h3><a href="shop-single.html">Turmeric Powder</a></h3>
			                            <div class="rating"><span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span></div>
			                            <div class="price">$12.99 <span class="prev-rate">$14.99</span></div>
			...
			<section class="why_choose_us">
				<div class="theme_title_bg" style="background-image: url(<?php bloginfo('template_directory');?>/assets/images/background/1.jpg);">
					<div class="theme_title center">
						<div class="container">
		        ...
		        <div class="container">
		            ...
		            <div class="row filter-list clearfix">
			            ...
			            <div class="col-md-4 col-sm-6 col-xs-12 mix mix_all default-item all beauty others" style="display: inline-block;">
			                <div class="inner-box">
			                    <div class="single-item center">
			                        <figure class="image-box"><img src="<?php bloginfo('template_directory');?>/assets/images/gallery/1.jpg" alt=""></figure>
			                        <div class="overlay-box">
			                        	<div class="inner">
				                        	<div class="image-view">
				                                <div class="icon-holder">
				                                    <a href="<?php bloginfo('template_directory');?>/assets/images/gallery/1.jpg" class="fancybox" data-fancybox-group="home-gallery" title="Gardener Gallery"><span class="icon-magnifier"></span></a>
				                                </div>
				                            </div>
				                        	<div class="bottom-content">
			            ...
			            <div class="col-md-4 col-sm-6 col-xs-12 mix mix_all default-item all others" style="display: inline-block;">
			                <div class="inner-box">
			                    <div class="single-item center">
			                        <figure class="image-box"><img src="<?php bloginfo('template_directory');?>/assets/images/gallery/2.jpg" alt=""></figure>
			                        <div class="overlay-box">
			                        	<div class="inner">
				                        	<div class="image-view">
				                                <div class="icon-holder">
			            ...
			            <div class="col-md-4 col-sm-6 col-xs-12 mix mix_all default-item all fruits vegetables beauty" style="display: inline-block;">
			                <div class="inner-box">
			                    <div class="single-item center">
			                        <figure class="image-box"><img src="<?php bloginfo('template_directory');?>/assets/images/gallery/3.jpg" alt=""></figure>
			                        <div class="overlay-box">
			                        	<div class="inner">
				                        	<div class="image-view">
				                                <div class="icon-holder">
			            ...
			            <div class="col-md-4 col-sm-6 col-xs-12 mix mix_all default-item all beauty others" style="display: inline-block;">
			                <div class="inner-box">
			                    <div class="single-item center">
			                        <figure class="image-box"><img src="<?php bloginfo('template_directory');?>/assets/images/gallery/4.jpg" alt=""></figure>
			                        <div class="overlay-box">
			                        	<div class="inner">
				                        	<div class="image-view">
				                                <div class="icon-holder">
				                                    <a href="<?php bloginfo('template_directory');?>/assets/images/gallery/1.jpg" class="fancybox"><span class="icon-magnifier"></span></a>
				                                </div>
				                            </div>
				                        	<div class="bottom-content">
				                        		<h4><a href="#">Coffee Break Cake</a></h4>
			            ...
			            <div class="col-md-4 col-sm-6 col-xs-12 mix mix_all default-item all fruits others" style="display: inline-block;">
			                <div class="inner-box">
			                    <div class="single-item center">
			                        <figure class="image-box"><img src="<?php bloginfo('template_directory');?>/assets/images/gallery/5.jpg" alt=""></figure>
			                        <div class="overlay-box">
			                        	<div class="inner">
				                        	<div class="image-view">
				                                <div class="icon-holder">
			            ...
			            <div class="col-md-4 col-sm-6 col-xs-12 mix mix_all default-item all fruits vegetables beauty others" style="display: inline-block;">
			                <div class="inner-box">
			                    <div class="single-item center">
			                        <figure class="image-box"><img src="<?php bloginfo('template_directory');?>/assets/images/gallery/6.jpg" alt=""></figure>
			                        <div class="overlay-box">
			                        	<div class="inner">
				                        	<div class="image-view">
				                                <div class="icon-holder">
				...
				<div class="container">
					...
					<div class="row">
						<div class="col-md-4 col-sm-6 col-xs-12">
							<div class="blogList_single_post clear_fix wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
	        					<div class="img_holder">
									<img src="<?php bloginfo('template_directory');?>/assets/images/blog/1.jpg" alt="News" class="img-responsive">
						...
						<div class="col-md-4 col-sm-6 col-xs-12">
							<div class="blogList_single_post clear_fix wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
	        					<div class="img_holder">
									<img src="<?php bloginfo('template_directory');?>/assets/images/blog/2.jpg" alt="News" class="img-responsive">
									<div class="opacity tran3s">
										<div class="icon">
											<span><a href="blog-details.html" class="border_round">+</a></span>
										</div> <!-- End of .icon -->
						...
						<div class="col-md-4 col-sm-6 col-xs-12">
							<div class="blogList_single_post clear_fix wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
	        					<div class="img_holder">
									<img src="<?php bloginfo('template_directory');?>/assets/images/blog/3.jpg" alt="News" class="img-responsive">
									<div class="opacity tran3s">
										<div class="icon">
											<span><a href="blog-details.html" class="border_round">+</a></span>
										</div> <!-- End of .icon -->
					...
					<div class="row">
						<div class="service_slider owl-carousel owl-theme">
								...
								<div class="item center">
									<div class="img_holder">
										<img src="<?php bloginfo('template_directory');?>/assets/images/team/1.jpg" alt="images">
								...
								<div class="item center">
									<div class="img_holder">
										<img src="<?php bloginfo('template_directory');?>/assets/images/team/2.jpg" alt="images">
										<div class="overlay tran3s">
											<div class="inner-box">
												<ul>
				                        			<li><a href="#"><span class="fa fa-facebook"></span></a></li>
								...
								<div class="item center">
									<div class="img_holder">
										<img src="<?php bloginfo('template_directory');?>/assets/images/team/3.jpg" alt="images">
										<div class="overlay tran3s">
											<div class="inner-box">
												<ul>
				                        			<li><a href="#"><span class="fa fa-facebook"></span></a></li>
		    ...
		    <section class="testimonials-section" style="background-image:url(<?php bloginfo('template_directory');?>/assets/images/parallax/1.jpg);">
		        <div class="container">
		            <div class="theme_title">
						<h2>testimonials</h2>
					</div>
		                	...
		                	<div class="inner-box">
		                        <div class="content">
		                            ...
		                            <div class="info clearfix">
		                            	<div class="author-thumb"><img src="<?php bloginfo('template_directory');?>/assets/images/team/a1.png" alt=""></div>
		                ...
		                <div class="slide-item">
		                	<div class="inner-box">
		                        <div class="content">
		                            ...
		                            <div class="info clearfix">
		                            	<div class="author-thumb"><img src="<?php bloginfo('template_directory');?>/assets/images/team/a2.png" alt=""></div>
		                ...
		                <div class="slide-item">
		                	<div class="inner-box">
		                        <div class="content">
		                            ...
		                            <div class="info clearfix">
		                            	<div class="author-thumb"><img src="<?php bloginfo('template_directory');?>/assets/images/team/a3.png" alt=""></div>
	        ...
	        <div class="partners wow fadeInUp">
	        	<div class="container">
	        		<div id="partner_logo" class="owl-carousel owl-theme">
						<div class="item"><img src="<?php bloginfo('template_directory');?>/assets/images/partner-logo/1.png" alt="logo"></div>
						<div class="item"><img src="<?php bloginfo('template_directory');?>/assets/images/partner-logo/2.png" alt="logo"></div>
						<div class="item"><img src="<?php bloginfo('template_directory');?>/assets/images/partner-logo/3.png" alt="logo"></div>
						<div class="item"><img src="<?php bloginfo('template_directory');?>/assets/images/partner-logo/4.png" alt="logo"></div>
						<div class="item"><img src="<?php bloginfo('template_directory');?>/assets/images/partner-logo/1.png" alt="logo"></div>
						<div class="item"><img src="<?php bloginfo('template_directory');?>/assets/images/partner-logo/2.png" alt="logo"></div>
						<div class="item"><img src="<?php bloginfo('template_directory');?>/assets/images/partner-logo/3.png" alt="logo"></div>
						<div class="item"><img src="<?php bloginfo('template_directory');?>/assets/images/partner-logo/4.png" alt="logo"></div>
