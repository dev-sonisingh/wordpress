								...
								<div class="blogList_single_post clear_fix wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
									...
									<div class="post">
										...
										<div class="text">
											...
											<ul>
												<li><a href="" class="tran3s"><i class="fa fa-user" aria-hidden="true"></i><?php the_author();?></a></li>
												<li>
													<?php the_tags('<i class="fa fa-tag" aria-hidden="true">','</i><i class="fa fa-tag" aria-hidden="true">','</i>')?>
													</li>
												<li><i class="fa fa-clock-o" aria-hidden="true"></i> 
													<?php the_date();?></li>
												<li><a href="" class="tran3s"><i class="fa fa-comments" aria-hidden="true"></i> <?php comments_number();?></a></li>
